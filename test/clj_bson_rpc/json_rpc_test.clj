...
(defn- gen-server-client! []
  (let [[a b] (create-duplex-stream)]
    [(connect-json-rpc! a simple-request-handlers {} {:json-framing :none})
     (connect-json-rpc! b {:json-framing :none})]))
...
(deftest requests-and-notifications
  (let [record (atom [])
        ...
        ;; services in server
        s (connect-json-rpc! a gen-request-handlers {} {:json-framing :none})
...
(deftest dynamic-selection-of-requests
  (let [request-handlers (atom {:echo (fn [msg] (apply str (reverse msg)))})
        [a b] (create-duplex-stream)
        [s c] [(connect-json-rpc! a request-handlers {} {:json-framing :none})
               (connect-json-rpc! b {:json-framing :none})]]
